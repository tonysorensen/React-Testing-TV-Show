...
//   {
//     id: "1234",
//     image: { medium: "fake pic", original: "fake pic too" },
//     season: "27",
//     number: "42",
...
test("Episodes shows data when rerendered with episodes prop", () => {
  ...
  //Act: rerender component with episodes data
  rerender(<Episodes episodes={data} />);
  const episode = getAllByTestId(/episode/i);

  //   Assert: 8 episodes should render from the data
